...
public class SnippetBot extends AdvancedRobot
{
	...
	int direction = 1;
	Random r = new Random();			//direction we are heading...1 = forward, -1 = backwards
	...
	void doMovement() {
		...
		setTurnRightRadians(target.bearing + PI/3 + randomValue); //every turn move to circle strafe the enemy
	}
